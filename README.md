...
| `color-bad-score`      | No                       | `red`                        | Badge color for "bad" scores. By default, this applies to fuck-u-code scores **< 50** (worst code quality range). Accepts any color name or hex (e.g. `"red"` or `#FF0000`).                                                                                                                                                  |
| `color-ok-score`       | No                       | `orange`                     | Badge color for "ok" scores (default range **50–79**). Use any CSS color value.                                                                                                                                                                                                                                               |
| `color-good-score`     | No                       | `yellow`                     | Badge color for "good" scores (default range **80–99**).                                                                                                                                                                                                                                                                      |
  ...
  scan-code:
    ...
    steps:
      ...
      - name: Run fuck-u-code Analysis
        uses: YaoYinYing/fuck-u-code-github-action@48ac6a2279a80bde8bf1016092fc60155e579afa
        with:
